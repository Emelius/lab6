<?php 
    ...
    $books = array();
            ...
            $books[] = array("title" => "The old man and the sea", "author" => "Ernest Hemingway");
            $books[] = array("title" => "Thinking with type", "author" => "Ellen Lupton");
            $books[] = array("title" => "The big bad wolf", "author" => "R. K. Rowling");
            $books[] = array("title" => "No Idea", "author" => "Nolan Ideos");
            $books[] = array("title" => "The great gatsby", "author" => "F. Scott Fitzgerald");
            ...
            # Get data from form
                ...
                echo '<table bgcolor="#eee" cellpadding="6">';
                echo '<tr><b><th>Title</th> <th>Author</th> <th>Reserve</th> </b> </tr>';
                #now we check if we have the ID or not in our array. If the search was a hit, it will assign something to our Database, if not, then it will not work.
                if ($id !== FALSE) {
                    $book = $books[$id];
                    $title = $book['title'];
                    $author = $book['author'];
